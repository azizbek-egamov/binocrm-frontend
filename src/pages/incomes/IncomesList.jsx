...
// Reusable Icons (Using common lucide-react style icons)
            ...
            <div className="incomes-main">
                <div className="main-header">
                    <div className="search-box" style={{ maxWidth: '300px' }}>
                        ...
                        <input 
                            type="text" 
                            placeholder="Tavsif yoki ism bo'yicha..." 
                            value={search}
                        ...
                        <form onSubmit={handleSubmit} style={{padding: '24px'}}>
                            ...
                            <div className="form-group" style={{marginBottom: '16px'}}>
                                ...
                                <input 
                                    ...
                                    placeholder="Masalan: Investor ulushi"
                                />
                            </div>
                            ...
                            <div className="form-group">
                                <label>Izoh</label>
                                <textarea 
                                    className="filter-input" style={{width: '100%', height: '80px', paddingTop: '10px'}}
                                    value={formData.note}
                ...
                <div className="modal-overlay" onClick={closeModal}>
                    <div className="modal-content" style={{maxWidth: '400px', textAlign: 'center', padding: '32px'}} onClick={e => e.stopPropagation()}>
                        <div style={{color: '#ef4444', marginBottom: '16px'}}>
                            <TrashIcon style={{width: '48px', height: '48px'}} />
                        </div>
